...
public class OpenYouTubePlayerActivity{
	...
	*/
	...
	public void playVideo(String VideoUri){
        ...
        activity.getWindow().setFlags(android.view.WindowManager.LayoutParams.FLAG_KEEP_SCREEN_ON, android.view.WindowManager.LayoutParams.FLAG_KEEP_SCREEN_ON);
		...
		lVideoIdUri =  Uri.parse("ytv://"+VideoUri);
	...
	private class QueryYouTubeTask extends AsyncTask<YouTubeId, ProgressUpdateInfo, Uri> {
		...
		protected Uri doInBackground(YouTubeId... pParams) {
			...
			try {
				...
				WifiManager lWifiManager = (WifiManager) OpenYouTubePlayerActivity.activity.getSystemService(Context.WIFI_SERVICE);
				TelephonyManager lTelephonyManager = (TelephonyManager) OpenYouTubePlayerActivity.activity.getSystemService(Context.TELEPHONY_SERVICE);
			...
			try {
			    ...
			    mVideoView.setOnCompletionListener(new OnCompletionListener(){
					...
					public void onCompletion(MediaPlayer pMp) {
						if(isCancelled())
							return;
						OpenYouTubePlayerActivity.getActivity().random();
					}
				...
				final MediaController lMediaController = new MediaController(OpenYouTubePlayerActivity.activity);
		...
		private void showErrorAlert() {
			...
			try {
				Builder lBuilder = new AlertDialog.Builder(OpenYouTubePlayerActivity.activity);
				...
				lBuilder.setPositiveButton("OK", new DialogInterface.OnClickListener(){
					...
					public void onClick(DialogInterface pDialog, int pWhich) {
						OpenYouTubePlayerActivity.activity.finish();
					}
